...
Не обязательно досконально и глубоко вникать в код и логику реализации каждого сервиса, цель этой реализации - показать как CRUD подход решает проблему соблюдения бизнес правил, и какие это проблемы порождает при таком подходе.  
