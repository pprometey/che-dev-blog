...
**Definition of Ready (DoR)** — это набор критериев, которым должна соответствовать постановка задачи перед тем, как разработчик приступит к её реализации.
...
**Совет:** используйте [BDD](https://ru.wikipedia.org/wiki/BDD_\(%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5\)) (Given-When-Then) для описания поведения в сценариях.
